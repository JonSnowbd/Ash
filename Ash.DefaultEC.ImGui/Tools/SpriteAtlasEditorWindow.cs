...
namespace Ash.ImGuiTools
{
	public class SpriteAtlasEditorWindow
	{
		...
		/// <summary>
		/// default location of SpriteAtlasPacker.exe. If you use a non-standard Ash install location set this before using the atlas editor
		/// </summary>
		public static string PathToSpritePacker = "../../../Ash/Ash.SpriteAtlasPacker/PrebuiltExecutable/SpriteAtlasPacker.exe";
