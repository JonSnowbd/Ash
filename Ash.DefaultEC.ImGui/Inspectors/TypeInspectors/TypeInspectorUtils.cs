...
using Ash.IEnumerableExtensions;
using System.Reflection;
using System;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using TI = Ash.ImGuiTools.TypeInspectors;
using System.Collections;


namespace Ash.ImGuiTools.TypeInspectors
{
	public static class TypeInspectorUtils
	{
		...
		static readonly Type componentType = typeof(ECComponent);
		...
		public static List<AbstractTypeInspector> GetInspectableProperties(object target)
		{
			...
			var isComponentSubclass = target is ECComponent;
		...
		public static AbstractTypeInspector GetInspectorForType(Type valueType, object target, MemberInfo memberInfo)
		{
			...
			// check for custom inspectors before checking Ash types in case a subclass implemented one
