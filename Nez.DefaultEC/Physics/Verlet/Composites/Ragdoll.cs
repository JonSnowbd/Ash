namespace Nez.Verlet
{
	public class Ragdoll : Composite
	{
		public Ragdoll(float x, float y, float bodyHeight)
		{
			...
			var head = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			head.Radius = headLength * 0.75f;
			head.Mass = 4;
			var shoulder = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			...
			var elbowLeft = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			var elbowRight = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			...
			var handLeft = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			var handRight = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			handLeft.Mass = 2;
			handRight.Mass = 2;
			...
			var pelvis = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			...
			var kneeLeft = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			var kneeRight = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			kneeLeft.Mass = 10;
			kneeRight.Mass = 10;
			...
			var footLeft = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
			var footRight = AddParticle(new Particle(x + Rand.Range(-5, 5), y + Rand.Range(-5, 5)));
