...
namespace Nez
{
	...
	public class TextureWipeTransition : SceneTransition
	{
		...
		public TextureWipeTransition(Func<ECScene> sceneLoadAction, Texture2D transitionTexture) : base(sceneLoadAction,
			true)
		{
		...
		public TextureWipeTransition(Func<ECScene> sceneLoadAction) : this(sceneLoadAction,
