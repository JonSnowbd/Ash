...
namespace Nez
{
	...
	public class SquaresTransition : SceneTransition
	{
		...
		public SquaresTransition(Func<ECScene> sceneLoadAction) : base(sceneLoadAction, true)
		{
			_destinationRect = PreviousSceneRender.Bounds;

			// load Effect and set defaults
			_squaresEffect = Core.Content.LoadEffect("./DefaultContent/effects/transitions/Squares.mgfxo");
