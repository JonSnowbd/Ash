...
namespace Nez
{
	...
	public class WindTransition : SceneTransition
	{
		...
		public WindTransition(Func<ECScene> sceneLoadAction) : base(sceneLoadAction, true)
		{
			_destinationRect = PreviousSceneRender.Bounds;

			// load Effect and set defaults
			_windEffect = Core.Content.LoadEffect("./DefaultContent/effects/transitions/Wind.mgfxo");
			Size = 0.3f;
			WindSegments = 100;
		}
