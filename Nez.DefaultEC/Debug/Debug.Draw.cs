...
namespace Nez
{
	public static partial class ECDebug
	{
		...
		internal static void Render()
		{
			...
			{
				if (Core.Scene != null && Core.Scene is ECScene scene && scene.Camera != null)
			...
			{
				var rtSize = (Core.Scene is ECScene scene) ? scene.SceneRenderTargetSize.Y : Screen.Size.Y;
		...
		{
			DrawText(text, Color.White, duration);
		}
