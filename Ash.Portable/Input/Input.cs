...
namespace Ash
{
	public static class Input
	{
		...
		/// when the Ash render is embedded in a larger window so that mouse coordinates can be translated
		/// to Ash space from the outer window coordinates and for simulating mouse input.
		/// </summary>
