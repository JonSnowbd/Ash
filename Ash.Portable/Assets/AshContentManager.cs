...
namespace Ash.Systems
{
	...
	public class NezContentManager : ContentManager
	{
		...
		/// <summary>
		/// loads an embedded Ash effect. These are any of the Effect subclasses in the Ash/Graphics/Effects folder.
	...
	/// <summary>
	/// the only difference between this class and NezContentManager is that this one can load embedded resources from the Ash.dll
	/// </summary>
