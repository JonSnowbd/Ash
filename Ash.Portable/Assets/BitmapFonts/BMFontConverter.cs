...
namespace Ash.BitmapFonts
{
...
#if SPRITEFONTPLUS
		public static Ash.BitmapFonts.BitmapFont NezBitmapFromBakedTTF(SpriteFontPlus.TtfFontBakerResult ttf)
		{
 ...
 new BitmapFonts.BitmapFontRegion(sprite, (char)key, character.XOffset, character.YOffset, character.XAdvance);
			...
			return new Ash.BitmapFonts.BitmapFont(regions, ttf.Height);
		}
#endif
	}
}