...
{
	/// <summary>
	/// SceneTransition is used to transition from one Scene to another or within a scene with an effect. If sceneLoadAction is null Ash
	...
	public abstract class SceneTransition
	{
		...
		/// <summary>
		/// if true, Ash will render the previous scene into previousSceneRender so that you can use it with your transition
		/// </summary>
		...
		/// </summary>
		protected Func<ECScene> sceneLoadAction;
		...
		protected SceneTransition(Func<ECScene> sceneLoadAction, bool wantsPreviousSceneRender = true)
		{
