...
namespace Ash
{
	...
	///
	/// </summary>
	public class ECComponent : IComparable<ECComponent>
	{
		/// <summary>
		/// the Entity this Component is attached to
		/// </summary>
		public ECEntity Entity;
		...
		public ECComponent SetEnabled(bool isEnabled)
		{
		...
		public ECComponent SetUpdateOrder(int updateOrder)
		{
		...
		/// </summary>
		public virtual ECComponent Clone()
		{
			var component = MemberwiseClone() as ECComponent;
			component.Entity = null;

			return component;
		}

		public int CompareTo(ECComponent other) => _updateOrder.CompareTo(other._updateOrder);
