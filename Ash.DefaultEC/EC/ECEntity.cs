...
namespace Ash
{
	public class ECEntity : IComparable<ECEntity>
	{
		...
		public ECEntity() : this(Utils.RandomString(8))
		{ }
		...
		public ECEntity SetTag(int tag)
		{
			if (_tag != tag)
			{
		...
		public ECEntity SetEnabled(bool isEnabled)
		{
		...
		public ECEntity SetUpdateOrder(int updateOrder)
		{
		...
		public void AttachToScene(ECScene newScene)
		{
			Scene = newScene;
		...
		/// </summary>
		public virtual ECEntity Clone(Vector2 position = default(Vector2))
		{
			var entity = Activator.CreateInstance(GetType()) as ECEntity;
		...
		protected void CopyFrom(ECEntity entity)
		{
			// Entity fields
			Tag = entity.Tag;
		...
		public T AddComponent<T>(T component) where T : ECComponent
		{
		...
		/// <returns>Scene.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T AddComponent<T>() where T : ECComponent, new()
		{
			var component = new T();
			component.Entity = this;
			Components.Add(component);
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T GetComponent<T>() where T : ECComponent => Components.GetComponent<T>(false);

		/// <summary>
		/// checks to see if the Entity has the component
		/// </summary>
		public bool HasComponent<T>() where T : ECComponent => Components.GetComponent<T>(false) != null;
		...
		/// <returns>The component.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T GetOrCreateComponent<T>() where T : ECComponent, new()
		{
		...
		/// <returns>The component.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public List<T> GetComponents<T>() where T : ECComponent => Components.GetComponents<T>();

		/// <summary>
		/// removes the first Component of type T from the components list
		/// </summary>
		public bool RemoveComponent<T>() where T : ECComponent
		{
		...
		public void RemoveComponent(ECComponent component) => Components.Remove(component);
		...
		public int CompareTo(ECEntity other)
		{
