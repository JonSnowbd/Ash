...
namespace Ash
{
	...
	/// </summary>
	public abstract class ECRenderable : ECComponent, IRenderable, IComparable<ECRenderable>
	{
		...
		public override void DebugRender(Batcher batcher)
		{
			...
			if (Entity.GetComponent<Collider>() == null)
				batcher.DrawHollowRect(Bounds, ECDebug.Colors.RenderableBounds);

			// draw a square for our pivot/origin
			batcher.DrawPixel(Entity.Transform.Position + _localOffset, ECDebug.Colors.RenderableCenter, 4);
		}
		...
		public ECRenderable SetMaterial(Material material)
		{
			Material = material;
		...
		public ECRenderable SetLayerDepth(float layerDepth)
		{
		...
		public ECRenderable SetRenderLayer(int renderLayer)
		{
		...
		public ECRenderable SetColor(Color color)
		{
			Color = color;
			return this;
		}
		...
		public ECRenderable SetLocalOffset(Vector2 offset)
		{
		...
		public int CompareTo(ECRenderable other)
		{
