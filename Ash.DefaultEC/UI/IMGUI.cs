...
namespace Ash
{
	...
	/// </summary>
	[System.Obsolete("This class is deprecated in favor of Ash.ImGui and will be removed in the future")]
	public class IMGUI
	{
		enum TextAlign
		{
		...
		static IMGUI()
		{
			...
			_font = Graphics.Instance.DevFont;
		...
		public static void BeginWindow(float x, float y, float width, float height, bool useRawMousePosition = true)
		{
			...
			var mousePos = useRawMousePosition ? Input.RawMousePosition : Input.MousePosition.ToPoint();
